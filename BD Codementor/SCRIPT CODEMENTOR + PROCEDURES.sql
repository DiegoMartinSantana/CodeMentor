...
CREATE TABLE CLASES_FINALIZADAS(
    IDCLASE INT NOT NULL,
    IDINSCRIPCION INT NOT NULL,
    PRIMARY KEY(IDCLASE,IDINSCRIPCION),
     CONSTRAINT Fk_ClasesFinalizadas_Usuarios FOREIGN KEY (IDINSCRIPCION) REFERENCES INSCRIPCIONES(IDINSCRIPCION),
 CONSTRAINT Fk_ClasesFinalizadas_Unidades FOREIGN KEY (IDCLASE) REFERENCES CLASES(IDCLASE),
